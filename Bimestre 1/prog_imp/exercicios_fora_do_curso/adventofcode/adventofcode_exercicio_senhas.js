...
for (i = 0; i <= senhas.length-1; i++)
{
    ...
    {
        senha_max = senhas[i].slice(3,5);
    }
    else if(senhas[i].charAt(3) >= '0' && senhas[i].charAt(3) <= '9')
    {
        senha_max = senhas[i].slice(2,4);
...
console.log(cont_senhas)
console.log(cont_senhas_2)
