...
EXPLAIN SELECT `bytes` FROM `cancoes` WHERE `nome` = "Be Yourself";
-- 3) Priority
...
CREATE USER "caio"@"localhost" IDENTIFIED BY "123";
CREATE USER "paulo"@"localhost" IDENTIFIED BY "321";
CREATE USER "natalia"@"localhost" IDENTIFIED BY "231";
